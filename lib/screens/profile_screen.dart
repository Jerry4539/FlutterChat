              ...
              Padding(
                ...
                child: IconButton(onPressed: () {
                    Navigator.push(context, MaterialPageRoute(
                        builder: (_) => SecurityScreen(user: User)));
                }, icon: const Icon(Icons.verified_user, color: Colors.blueAccent,)),
              ),
              // Padding(
              //   padding: EdgeInsets.only(top: 0, right: 10),
              //   child: Icon(Icons.verified_user, color: Colors.blueAccent, size: 28,),
              // ),
            ],),
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          prefixIcon:
                          const Icon(
                              Icons.person_3_rounded, color: Colors.blue),
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12)),
                          hintText: 'eg. Laal Bahadur',
